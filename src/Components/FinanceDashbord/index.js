    ...
    <FinenceDashbordContainer>
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col lg={6}>
          ...
          <Row style={{ marginTop: '16px' }}>
            <Col span={24} >
              <DoughnutChart title={'Paymet Report'} labels={PayPieLabel} data={PayPie} />
            </Col>
          </Row>
      ...
      <Row gutter={[16, 16]}>
        <Col lg={12} md={12} sm={24} xs={24} >
          <ForReportDoughnutChart title={'Referer Report'} data={PayRef} labels={PayRefLabel} />

        </Col>
        <Col lg={12} md={12} sm={24} xs={24} >
          <ForReportDoughnutChart title={'Requestor Report'} data={PayReq} labels={PayReqLabel} />
        </Col>
      </Row>
